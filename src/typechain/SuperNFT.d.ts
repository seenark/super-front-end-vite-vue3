...
interface SuperNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class SuperNFT extends BaseContract {
  ...
  callStatic: {
    ...
    createNFT(tokenURI: string, overrides?: CallOverrides): Promise<BigNumber>;
